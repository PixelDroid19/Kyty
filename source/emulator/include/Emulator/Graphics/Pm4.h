...
constexpr uint32_t DB_RENDER_CONTROL_DEPTH_COPY_SHIFT                = 2;
constexpr uint32_t DB_RENDER_CONTROL_DEPTH_COPY_MASK                 = 0x1;
constexpr uint32_t DB_RENDER_CONTROL_STENCIL_COPY_SHIFT              = 3;
constexpr uint32_t DB_RENDER_CONTROL_STENCIL_COPY_MASK               = 0x1;
...
constexpr uint32_t PA_SC_WINDOW_OFFSET_WINDOW_X_SHIFT = 0;
constexpr uint32_t PA_SC_WINDOW_OFFSET_WINDOW_X_MASK  = 0xFFFF;
constexpr uint32_t PA_SC_WINDOW_OFFSET_WINDOW_Y_SHIFT = 16;
constexpr uint32_t PA_SC_WINDOW_OFFSET_WINDOW_Y_MASK  = 0xFFFF;
...
constexpr uint32_t SPI_SHADER_PGM_RSRC2_PS_RASTER_ORDERED_SHADING_SHIFT   = 25;
constexpr uint32_t SPI_SHADER_PGM_RSRC2_PS_RASTER_ORDERED_SHADING_MASK    = 0x3;
