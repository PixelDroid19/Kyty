...
struct DebugStatsPerformanceSnapshot
{
	...
	uint64_t command_processor_runs       = 0;
	uint64_t command_processor_run_ns     = 0;
	uint64_t command_processor_run_max_ns = 0;
	uint64_t draw_processor_calls         = 0;
	uint64_t draw_processor_ns            = 0;
	uint64_t draw_processor_max_ns        = 0;
	...
	uint64_t draw_state_setup_max_ns        = 0;
	uint64_t draw_materialization_ns        = 0;
	uint64_t draw_materialization_max_ns    = 0;
	uint64_t draw_pipeline_setup_ns         = 0;
	uint64_t draw_pipeline_setup_max_ns     = 0;
	uint64_t draw_resource_binding_ns       = 0;
	uint64_t draw_resource_binding_max_ns   = 0;
	uint64_t draw_command_emission_ns       = 0;
	uint64_t draw_command_emission_max_ns   = 0;
	uint64_t draw_vertex_buffer_binding_ns     = 0;
	uint64_t draw_vertex_buffer_binding_max_ns = 0;
	uint64_t draw_index_buffer_binding_ns      = 0;
	uint64_t draw_index_buffer_binding_max_ns  = 0;
	uint64_t draw_descriptor_storage_ns        = 0;
	uint64_t draw_descriptor_storage_max_ns    = 0;
	uint64_t                    draw_descriptor_texture_ns        = 0;
	uint64_t                    draw_descriptor_texture_max_ns    = 0;
	uint64_t                    draw_descriptor_sampler_ns        = 0;
	uint64_t                    draw_descriptor_sampler_max_ns    = 0;
	uint64_t                    draw_descriptor_finalize_ns       = 0;
