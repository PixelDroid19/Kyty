                                   ...
                                   const Loader::MissingImportDiagnostics& imports, const Loader::ModuleLoadPlanDiagnostics& load_plan)
{
	...
	out += ",\"command_processor_runs\":" + std::to_string(performance.command_processor_runs);
	out += ",\"command_processor_run_ns\":" + std::to_string(performance.command_processor_run_ns);
	out += ",\"command_processor_run_max_ns\":" + std::to_string(performance.command_processor_run_max_ns);
	out += ",\"draw_processor_calls\":" + std::to_string(performance.draw_processor_calls);
	out += ",\"draw_processor_ns\":" + std::to_string(performance.draw_processor_ns);
	out += ",\"draw_processor_max_ns\":" + std::to_string(performance.draw_processor_max_ns);
	out += ",\"dispatch_processor_calls\":" + std::to_string(performance.dispatch_processor_calls);
	out += ",\"dispatch_processor_ns\":" + std::to_string(performance.dispatch_processor_ns);
	out += ",\"dispatch_processor_max_ns\":" + std::to_string(performance.dispatch_processor_max_ns);
	out += ",\"draw_render_lock_wait_ns\":" + std::to_string(performance.draw_render_lock_wait_ns);
	out += ",\"draw_render_lock_wait_max_ns\":" + std::to_string(performance.draw_render_lock_wait_max_ns);
	out += ",\"draw_state_setup_ns\":" + std::to_string(performance.draw_state_setup_ns);
	out += ",\"draw_state_setup_max_ns\":" + std::to_string(performance.draw_state_setup_max_ns);
	out += ",\"draw_materialization_ns\":" + std::to_string(performance.draw_materialization_ns);
	out += ",\"draw_materialization_max_ns\":" + std::to_string(performance.draw_materialization_max_ns);
	out += ",\"draw_pipeline_setup_ns\":" + std::to_string(performance.draw_pipeline_setup_ns);
	out += ",\"draw_pipeline_setup_max_ns\":" + std::to_string(performance.draw_pipeline_setup_max_ns);
	out += ",\"draw_resource_binding_ns\":" + std::to_string(performance.draw_resource_binding_ns);
	out += ",\"draw_resource_binding_max_ns\":" + std::to_string(performance.draw_resource_binding_max_ns);
	out += ",\"draw_command_emission_ns\":" + std::to_string(performance.draw_command_emission_ns);
	out += ",\"draw_command_emission_max_ns\":" + std::to_string(performance.draw_command_emission_max_ns);
	out += ",\"draw_vertex_buffer_binding_ns\":" + std::to_string(performance.draw_vertex_buffer_binding_ns);
	out += ",\"draw_vertex_buffer_binding_max_ns\":" + std::to_string(performance.draw_vertex_buffer_binding_max_ns);
	out += ",\"draw_index_buffer_binding_ns\":" + std::to_string(performance.draw_index_buffer_binding_ns);
	out += ",\"draw_index_buffer_binding_max_ns\":" + std::to_string(performance.draw_index_buffer_binding_max_ns);
	out += ",\"draw_descriptor_storage_ns\":" + std::to_string(performance.draw_descriptor_storage_ns);
	out += ",\"draw_descriptor_storage_max_ns\":" + std::to_string(performance.draw_descriptor_storage_max_ns);
	out += ",\"draw_descriptor_texture_ns\":" + std::to_string(performance.draw_descriptor_texture_ns);
	out += ",\"draw_descriptor_texture_max_ns\":" + std::to_string(performance.draw_descriptor_texture_max_ns);
	out += ",\"draw_descriptor_sampler_ns\":" + std::to_string(performance.draw_descriptor_sampler_ns);
