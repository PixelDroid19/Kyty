...
std::string PerformanceResult(bool reset)
{
	...
	std::snprintf(buf, sizeof(buf),
	              ...
	              static_cast<unsigned long long>(stats.pipeline_cache_checkpoint_count),
	              static_cast<unsigned long long>(stats.pipeline_cache_checkpoint_bytes),
	              static_cast<unsigned long long>(stats.pipeline_cache_checkpoint_ns),
	              static_cast<unsigned long long>(stats.pipeline_cache_checkpoint_max_ns),
	              static_cast<unsigned long long>(stats.pipeline_cache_checkpoint_written),
	              static_cast<unsigned long long>(stats.pipeline_cache_checkpoint_failed),
	              static_cast<unsigned long long>(stats.pipeline_cache_checkpoint_budget_exceeded),
	...
	std::string out(buf);
	out += "\"command_processor_runs\":" + std::to_string(stats.command_processor_runs);
	out += ",\"command_processor_run_ns\":" + std::to_string(stats.command_processor_run_ns);
	out += ",\"command_processor_run_max_ns\":" + std::to_string(stats.command_processor_run_max_ns);
	out += ",\"draw_processor_calls\":" + std::to_string(stats.draw_processor_calls);
	out += ",\"draw_processor_ns\":" + std::to_string(stats.draw_processor_ns);
	out += ",\"draw_processor_max_ns\":" + std::to_string(stats.draw_processor_max_ns);
	out += ",\"dispatch_processor_calls\":" + std::to_string(stats.dispatch_processor_calls);
	out += ",\"dispatch_processor_ns\":" + std::to_string(stats.dispatch_processor_ns);
	out += ",\"dispatch_processor_max_ns\":" + std::to_string(stats.dispatch_processor_max_ns);
	out += ",\"draw_render_lock_wait_ns\":" + std::to_string(stats.draw_render_lock_wait_ns);
	out += ",\"draw_render_lock_wait_max_ns\":" + std::to_string(stats.draw_render_lock_wait_max_ns);
	out += ",\"draw_state_setup_ns\":" + std::to_string(stats.draw_state_setup_ns);
	out += ",\"draw_state_setup_max_ns\":" + std::to_string(stats.draw_state_setup_max_ns);
	out += ",\"draw_materialization_ns\":" + std::to_string(stats.draw_materialization_ns);
	out += ",\"draw_materialization_max_ns\":" + std::to_string(stats.draw_materialization_max_ns);
	out += ",\"draw_pipeline_setup_ns\":" + std::to_string(stats.draw_pipeline_setup_ns);
	out += ",\"draw_pipeline_setup_max_ns\":" + std::to_string(stats.draw_pipeline_setup_max_ns);
	out += ",\"draw_resource_binding_ns\":" + std::to_string(stats.draw_resource_binding_ns);
	out += ",\"draw_resource_binding_max_ns\":" + std::to_string(stats.draw_resource_binding_max_ns);
	out += ",\"draw_command_emission_ns\":" + std::to_string(stats.draw_command_emission_ns);
	out += ",\"draw_command_emission_max_ns\":" + std::to_string(stats.draw_command_emission_max_ns);
	out += ",\"draw_vertex_buffer_binding_ns\":" + std::to_string(stats.draw_vertex_buffer_binding_ns);
	out += ",\"draw_vertex_buffer_binding_max_ns\":" + std::to_string(stats.draw_vertex_buffer_binding_max_ns);
	out += ",\"draw_index_buffer_binding_ns\":" + std::to_string(stats.draw_index_buffer_binding_ns);
	out += ",\"draw_index_buffer_binding_max_ns\":" + std::to_string(stats.draw_index_buffer_binding_max_ns);
	out += ",\"draw_descriptor_storage_ns\":" + std::to_string(stats.draw_descriptor_storage_ns);
	out += ",\"draw_descriptor_storage_max_ns\":" + std::to_string(stats.draw_descriptor_storage_max_ns);
	out += ",\"draw_descriptor_texture_ns\":" + std::to_string(stats.draw_descriptor_texture_ns);
	out += ",\"draw_descriptor_texture_max_ns\":" + std::to_string(stats.draw_descriptor_texture_max_ns);
	out += ",\"draw_descriptor_sampler_ns\":" + std::to_string(stats.draw_descriptor_sampler_ns);
