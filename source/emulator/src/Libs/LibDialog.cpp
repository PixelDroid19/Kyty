...
void RegisterSaveDataDialogFunctions(::Kyty::Hle::HleSymbolRegistry* symbols, const LibraryIdentity& identity)
{
...
void RegisterMsgDialogFunctions(::Kyty::Hle::HleSymbolRegistry* symbols, const LibraryIdentity& identity)
{
