...
const RecompilerFunc* RecompFunc(ShaderInstructionType type, ShaderInstructionFormat::Format format)
{
    ...
    {Recompile_ImageSample_Vdata2Vaddr3StSsDmaskC,         ShaderInstructionType::ImageSample,         ShaderInstructionFormat::Vdata2Vaddr3StSsDmaskC,         {""}},
    ...
    {Recompile_S_XXX_B64_Sdst2Ssrc02Ssrc12, ShaderInstructionType::SCmovB64,    ShaderInstructionFormat::Sdst2Ssrc02Ssrc12, {"%ts_<index> = OpLoad %uint %scc",
                                                                                                                             "%tsb_<index> = OpINotEqual %bool %ts_<index> %uint_0",
                                                                                                                             "%tb_<index> = OpSelect %uint %tsb_<index> %t0_<index> %t2_<index>",
                                                                                                                             "%td_<index> = OpSelect %uint %tsb_<index> %t1_<index> %t3_<index>" }, SccCheck::None},
...
%t_<index> = OpSelect %float %minmax_lhs_nan_<index> %t1_<index> %minmax_rhs_number_<index>)"}},
    ...
    {Recompile_VCmpF16_Special_SmaskVsrc0Vsrc1, ShaderInstructionType::VCmpFF16,   ShaderInstructionFormat::SmaskVsrc0Vsrc1,  {"%t2_<index> = OpIEqual %bool %uint_0 %uint_1"}},
    {Recompile_VCmpF16_Special_SmaskVsrc0Vsrc1, ShaderInstructionType::VCmpTruF16, ShaderInstructionFormat::SmaskVsrc0Vsrc1,  {"%t2_<index> = OpINotEqual %bool %uint_0 %uint_1"}},
    {Recompile_VCmpF16_Special_SmaskVsrc0Vsrc1, ShaderInstructionType::VCmpOF16,   ShaderInstructionFormat::SmaskVsrc0Vsrc1,  {"%n0_<index> = OpIsNan %bool %hc0_<index>", "%n1_<index> = OpIsNan %bool %hc1_<index>", "%u_<index> = OpLogicalOr %bool %n0_<index> %n1_<index>", "%t2_<index> = OpLogicalNot %bool %u_<index>"}},
    {Recompile_VCmpF16_Special_SmaskVsrc0Vsrc1, ShaderInstructionType::VCmpUF16,   ShaderInstructionFormat::SmaskVsrc0Vsrc1,  {"%n0_<index> = OpIsNan %bool %hc0_<index>", "%n1_<index> = OpIsNan %bool %hc1_<index>", "%t2_<index> = OpLogicalOr %bool %n0_<index> %n1_<index>"}},
    ...
    {Recompile_VCmpF64_Special_SmaskVsrc0Vsrc1, ShaderInstructionType::VCmpFF64,   ShaderInstructionFormat::SmaskVsrc0Vsrc1,  {"%t2_<index> = OpIEqual %bool %uint_0 %uint_1"}},
    {Recompile_VCmpF64_Special_SmaskVsrc0Vsrc1, ShaderInstructionType::VCmpTruF64, ShaderInstructionFormat::SmaskVsrc0Vsrc1,  {"%t2_<index> = OpINotEqual %bool %uint_0 %uint_1"}},
    {Recompile_VCmpF64_Special_SmaskVsrc0Vsrc1, ShaderInstructionType::VCmpOF64,   ShaderInstructionFormat::SmaskVsrc0Vsrc1,  {"%n0_<index> = OpIsNan %bool %d0_<index>", "%n1_<index> = OpIsNan %bool %d1_<index>", "%u_<index> = OpLogicalOr %bool %n0_<index> %n1_<index>", "%t2_<index> = OpLogicalNot %bool %u_<index>"}},
    {Recompile_VCmpF64_Special_SmaskVsrc0Vsrc1, ShaderInstructionType::VCmpUF64,   ShaderInstructionFormat::SmaskVsrc0Vsrc1,  {"%n0_<index> = OpIsNan %bool %d0_<index>", "%n1_<index> = OpIsNan %bool %d1_<index>", "%t2_<index> = OpLogicalOr %bool %n0_<index> %n1_<index>"}},
    ...
    {Recompile_VCmpx16_XXX_SmaskVsrc0Vsrc1,   ShaderInstructionType::VCmpxLtI16,   ShaderInstructionFormat::SmaskVsrc0Vsrc1,      {"OpSLessThan", "s"}},
    {Recompile_VCmpx16_XXX_SmaskVsrc0Vsrc1,   ShaderInstructionType::VCmpxEqI16,   ShaderInstructionFormat::SmaskVsrc0Vsrc1,      {"OpIEqual", "s"}},
    {Recompile_VCmpx16_XXX_SmaskVsrc0Vsrc1,   ShaderInstructionType::VCmpxLeI16,   ShaderInstructionFormat::SmaskVsrc0Vsrc1,      {"OpSLessThanEqual", "s"}},
    {Recompile_VCmpx16_XXX_SmaskVsrc0Vsrc1,   ShaderInstructionType::VCmpxGtI16,   ShaderInstructionFormat::SmaskVsrc0Vsrc1,      {"OpSGreaterThan", "s"}},
    {Recompile_VCmpx16_XXX_SmaskVsrc0Vsrc1,   ShaderInstructionType::VCmpxNeI16,   ShaderInstructionFormat::SmaskVsrc0Vsrc1,      {"OpINotEqual", "s"}},
    {Recompile_VCmpx16_XXX_SmaskVsrc0Vsrc1,   ShaderInstructionType::VCmpxGeI16,   ShaderInstructionFormat::SmaskVsrc0Vsrc1,      {"OpSGreaterThanEqual", "s"}},
    {Recompile_VCmpx16_XXX_SmaskVsrc0Vsrc1,   ShaderInstructionType::VCmpxLtU16,   ShaderInstructionFormat::SmaskVsrc0Vsrc1,      {"OpULessThan"}},
    {Recompile_VCmpx16_XXX_SmaskVsrc0Vsrc1,   ShaderInstructionType::VCmpxEqU16,   ShaderInstructionFormat::SmaskVsrc0Vsrc1,      {"OpIEqual"}},
    {Recompile_VCmpx16_XXX_SmaskVsrc0Vsrc1,   ShaderInstructionType::VCmpxLeU16,   ShaderInstructionFormat::SmaskVsrc0Vsrc1,      {"OpULessThanEqual"}},
    ...
    {Recompile_VCmpxF16_XXX_SmaskVsrc0Vsrc1,  ShaderInstructionType::VCmpxGtF16,   ShaderInstructionFormat::SmaskVsrc0Vsrc1,      {"OpFOrdGreaterThan"}},
    {Recompile_VCmpxF16_XXX_SmaskVsrc0Vsrc1,  ShaderInstructionType::VCmpxLgF16,   ShaderInstructionFormat::SmaskVsrc0Vsrc1,      {"OpFOrdNotEqual"}},
    {Recompile_VCmpxF16_XXX_SmaskVsrc0Vsrc1,  ShaderInstructionType::VCmpxGeF16,   ShaderInstructionFormat::SmaskVsrc0Vsrc1,      {"OpFOrdGreaterThanEqual"}},
    {Recompile_VCmpxF16_XXX_SmaskVsrc0Vsrc1,  ShaderInstructionType::VCmpxNgeF16,  ShaderInstructionFormat::SmaskVsrc0Vsrc1,      {"OpFUnordLessThan"}},
    {Recompile_VCmpxF16_XXX_SmaskVsrc0Vsrc1,  ShaderInstructionType::VCmpxNlgF16,  ShaderInstructionFormat::SmaskVsrc0Vsrc1,      {"OpFUnordEqual"}},
    {Recompile_VCmpxF16_XXX_SmaskVsrc0Vsrc1,  ShaderInstructionType::VCmpxNgtF16,  ShaderInstructionFormat::SmaskVsrc0Vsrc1,      {"OpFUnordLessThanEqual"}},
    {Recompile_VCmpxF16_XXX_SmaskVsrc0Vsrc1,  ShaderInstructionType::VCmpxNleF16,  ShaderInstructionFormat::SmaskVsrc0Vsrc1,      {"OpFUnordGreaterThan"}},
    {Recompile_VCmpxF16_XXX_SmaskVsrc0Vsrc1,  ShaderInstructionType::VCmpxNltF16,  ShaderInstructionFormat::SmaskVsrc0Vsrc1,      {"OpFUnordGreaterThanEqual"}},
    {Recompile_V16_XXX_VdstVsrc0Vsrc1,        ShaderInstructionType::VAddI16,     ShaderInstructionFormat::SVdstSVsrc0SVsrc1,      {"%t_<index> = OpIAdd %uint %i0x_<index> %i1x_<index>", "s"}},
    {Recompile_V16_XXX_VdstVsrc0Vsrc1,        ShaderInstructionType::VAddU16,     ShaderInstructionFormat::SVdstSVsrc0SVsrc1,      {"%t_<index> = OpIAdd %uint %i0x_<index> %i1x_<index>"}},
    {Recompile_V16_XXX_VdstVsrc0Vsrc1,        ShaderInstructionType::VSubI16,     ShaderInstructionFormat::SVdstSVsrc0SVsrc1,      {"%t_<index> = OpISub %uint %i0x_<index> %i1x_<index>", "s"}},
    {Recompile_V16_XXX_VdstVsrc0Vsrc1,        ShaderInstructionType::VSubU16,     ShaderInstructionFormat::SVdstSVsrc0SVsrc1,      {"%t_<index> = OpISub %uint %i0x_<index> %i1x_<index>"}},
    {Recompile_V16_XXX_VdstVsrc0Vsrc1,        ShaderInstructionType::VMulI16,     ShaderInstructionFormat::SVdstSVsrc0SVsrc1,      {"%t_<index> = OpIMul %uint %i0x_<index> %i1x_<index>", "s"}},
    {Recompile_V16_XXX_VdstVsrc0Vsrc1,        ShaderInstructionType::VMulU16,     ShaderInstructionFormat::SVdstSVsrc0SVsrc1,      {"%t_<index> = OpIMul %uint %i0x_<index> %i1x_<index>"}},
    {Recompile_V16_XXX_VdstVsrc0Vsrc1,        ShaderInstructionType::VMinI16,     ShaderInstructionFormat::SVdstSVsrc0SVsrc1,      {"%t_<index> = OpExtInst %uint %GLSL_std_450 SMin %i0x_<index> %i1x_<index>", "s"}},
