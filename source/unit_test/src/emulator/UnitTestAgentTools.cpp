...
TEST(AgentTools, PerformanceSnapshotResetUsesIndependentBaseline)
{
	...
	DebugStatsRecordCommandProcessorRun(600000);
	DebugStatsRecordDrawProcessor(350000);
	DebugStatsRecordDispatchProcessor(150000);
	DebugStatsRecordDrawRenderLockWait(10000);
	DebugStatsRecordDrawStateSetup(20000);
	DebugStatsRecordDrawMaterialization(30000);
	DebugStatsRecordDrawPipelineSetup(40000);
	DebugStatsRecordDrawResourceBinding(50000);
	DebugStatsRecordDrawCommandEmission(60000);
	DebugStatsRecordDrawVertexBufferBinding(70000);
	DebugStatsRecordDrawIndexBufferBinding(80000);
	DebugStatsRecordDrawDescriptorStorage(90000);
	...
	EXPECT_EQ(first.command_processor_runs, 1u);
	EXPECT_EQ(first.command_processor_run_ns, 600000u);
	EXPECT_EQ(first.command_processor_run_max_ns, 600000u);
	EXPECT_EQ(first.draw_processor_calls, 1u);
	EXPECT_EQ(first.draw_processor_ns, 350000u);
	EXPECT_EQ(first.draw_processor_max_ns, 350000u);
	EXPECT_EQ(first.dispatch_processor_calls, 1u);
	EXPECT_EQ(first.dispatch_processor_ns, 150000u);
	EXPECT_EQ(first.dispatch_processor_max_ns, 150000u);
	EXPECT_EQ(first.draw_render_lock_wait_ns, 10000u);
	EXPECT_EQ(first.draw_state_setup_ns, 20000u);
	EXPECT_EQ(first.draw_materialization_ns, 30000u);
	EXPECT_EQ(first.draw_pipeline_setup_ns, 40000u);
	EXPECT_EQ(first.draw_resource_binding_ns, 50000u);
	EXPECT_EQ(first.draw_command_emission_ns, 60000u);
	EXPECT_EQ(first.draw_vertex_buffer_binding_ns, 70000u);
	EXPECT_EQ(first.draw_index_buffer_binding_ns, 80000u);
	EXPECT_EQ(first.draw_descriptor_storage_ns, 90000u);
	...
	EXPECT_EQ(second.command_processor_runs, 0u);
	EXPECT_EQ(second.command_processor_run_ns, 0u);
	EXPECT_EQ(second.command_processor_run_max_ns, 0u);
	EXPECT_EQ(second.draw_processor_calls, 0u);
	EXPECT_EQ(second.draw_processor_ns, 0u);
	EXPECT_EQ(second.draw_processor_max_ns, 0u);
	EXPECT_EQ(second.dispatch_processor_calls, 0u);
	EXPECT_EQ(second.dispatch_processor_ns, 0u);
	EXPECT_EQ(second.dispatch_processor_max_ns, 0u);
	EXPECT_EQ(second.draw_render_lock_wait_ns, 0u);
	EXPECT_EQ(second.draw_state_setup_ns, 0u);
	EXPECT_EQ(second.draw_materialization_ns, 0u);
	EXPECT_EQ(second.draw_pipeline_setup_ns, 0u);
	EXPECT_EQ(second.draw_resource_binding_ns, 0u);
	EXPECT_EQ(second.draw_command_emission_ns, 0u);
	EXPECT_EQ(second.draw_vertex_buffer_binding_ns, 0u);
	EXPECT_EQ(second.draw_index_buffer_binding_ns, 0u);
	EXPECT_EQ(second.draw_descriptor_storage_ns, 0u);
