...
description: "Kyty PS5 emulator agent toolkit: run kyty_agent_doctor first, then strict reproduce, frontier manifest, contract gates, kyty_agent observation, matrix/playable regression. Use for guest crashes, HLE/NID work, PM4/GPU bugs, multi-case matrix, or any Kyty bring-up task."
license: MIT
