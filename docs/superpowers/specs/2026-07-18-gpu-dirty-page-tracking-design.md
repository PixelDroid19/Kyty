...
external reference provides a useful clean-room architectural reference: protect guest
...
- No attempt to make Darwin ARM64 write-fault classification work in this phase;
  ...
  reliable write bit.
- No copy of external reference code or private implementation details.
